...
<p align="justify">Os riscos de alto nível são aqueles identificados inicialmente no projeto e como devem ser realizadas as ações para mitigar e gerenciar estes riscos. Sendo eles: </p>

Riscos| Plano de Ação
---|---
Falta de conhecimento técnico da equipe | Realizar treinamentos, utilizar Quadro de Conhecimento para medir nível dos membros e planejar pareamentos
Desistencia de algum membro da disciplina | Adequação do Backlog com redução do escopo, compensar horas do membro entre o restante da equipe.
...
Falha em equipamentos de membros do time | Alocar pareamentos com um membro que tenha disponibilidade parecida, buscar disponibilidade em laboratórios da faculdade para o membro utilizar.
Indisponibilidade horária | Tentar adaptar horários de acordo com essas indisponibilidades, marcar encontros não presenciais em casos de necessidade
...
Falha de comunicação | Modificar estratégias de comunicação, realizar mais encontros presenciais, criar canais de comunicação anonimos para que todos possam se expressar livremente.

# 10. Resumo do Cronograma de Marcos
Data | Marco | Atividade
---| ---| ---
10/08/2019| Início do projeto | Data de início da Sprint 0
01/09/2019| Release 1 (R1)| Primeira entrega oficial do projeto
19/11/2019| Release 2 (R2)| Entrega do produto final

# 11. Resumo do Orçamento
<p align="justify"> Os salários foram definidos com base na busca acerca da média salarial dos respectivos cargos no mercado de trabalho. E considerando a carga horária proposta pela disciplina(8 horas semanais), assim como o tempo de duração estimado do projeto(3 meses e meio)</p>

### Recursos Humanos
Cargo |Quantidade| Salário por Hora | Salário Total
---|:---:|:---:|:---:
Scrum Master|1| R$ 40,19 | R$ 5.625,20
Product Owner|1|R$ 36,12| R$ 5.056,80
DevOps|1|R$ 39,64|R$ 5.550,30
Desenvolvedor Junior| 7| R$ 13,38 | R$ 13.117,30
**Total**|-|-| R$ 29.349,60

### Aquisições
Equipamento| Quantidade | Finalidade| Valor unitário| Valor total
---|:---:|---|:---:|:---:
Smartphones| 10| Teste da versão mobile e comunicação com equipe| R$ 700,00| R$ 7.000,00
Notebooks | 10| Desenvolvimento| R$ 2.600,00| R$ 26.000,00
Droplet na Digital Ocean com 3GB de RAM, 1vCPU, 60GB de SSD e 3TB de transferência de dados | 2| Deploy Contínuo| R$ 61,05| R$ 122,10
**Total**|-|-|-| R$ 33.122,10
